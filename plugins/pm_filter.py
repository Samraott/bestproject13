...
async def advantage_spoll_choker(bot, query):
    ...
    if not movies:
        return await query.answer("You Are Using My Old Messages🥲,Try Asking Again 🤠 ", show_alert=True)
            ...
            msg1 = await query.message.reply(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton("✧🎀𝐂𝐀𝐍'𝐓 𝐀𝐂𝐂𝐄𝐒𝐒❓ 𝐂𝐋𝐈𝐂𝐊 𝐇𝐄𝐑𝐄🎀✧", url=f'https://t.me/+AhuGzoZgPdEzMTBl')
                        ]
                    ]
                )
            )
...
async def auto_filter(client, msg: pyrogram.types.Message, spoll=False):
    ...
    if imdb and imdb.get('poster'):
        try:
            fmsg = await message.reply_photo(photo='https://telegra.ph/file/b417bdd01331179d5787c.jpg', caption=cap[:1024],
                                      reply_markup=InlineKeyboardMarkup(btn))
